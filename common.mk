...
PRODUCT_PACKAGES += \
    ...
    custom.hardware.biometrics.fingerprint.udfps-service.oplus
...
# Alert slider
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/privapp-permissions-alertslider.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/privapp-permissions-alertslider.xml
